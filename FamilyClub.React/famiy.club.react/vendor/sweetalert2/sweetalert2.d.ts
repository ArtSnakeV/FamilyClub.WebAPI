 ...
 * ```
 */
 function fire (options: SweetAlertOptions): Promise<SweetAlertResult<Awaited >>
 ...
 * ```
 */
 function fire (title?: string, html?: string, icon?: SweetAlertIcon): Promise<SweetAlertResult<Awaited >>
 ...
 */
 function close(result?: Partial): void
 ...
 */
 ...
 type SyncOrAsync = T | Promise | { toPromise: () => T }

 type ValueOrThunk = T | (() => T)
 ...
 export type SweetAlertShowClass = Readonly 
 ...
 * @default undefined
 */
 inputValidator?: (value: string) => SyncOrAsync 
 }
 | {
 input: 'file'
 /**
 ...
 * @default undefined
 */
 inputValidator?: (file: File | FileList | null) => SyncOrAsync 
 }
 ...
 */
 ...
 /**
 * The declarative of the popup. All API prams can be set via
 * ` `, e.g.
 * ` `
 *
 ...
 * @default true
 */
 allowOutsideClick?: ValueOrThunk | undefined
 ...
 * @default true
 */
 allowEscapeKey?: ValueOrThunk | undefined
 ...
 * @deprecated
 */
 allowEnterKey?: ValueOrThunk | undefined
 ...
 * @default undefined
 */
 preConfirm?(inputValue: any): SyncOrAsync 
 ...
 * @default ''
 */
 inputValue?: SyncOrAsync | null | undefined
