      ...
      <ul className="flex items-center gap-2 mx-auto">
        <li>
          <button
            ...
            className="w-10 h-10 flex items-center justify-center text-[var(--foreground-primary)] disabled:opacity-40"
        ...
        {pageItems.map((item, idx) =>
          item === "ellipsis-left" || item === "ellipsis-right" ? (
            <li key={item + idx}>
              <span className="w-10 h-10 flex items-center justify-center text-[18px] font-['Source_Sans_Pro'] text-[var(--color-muted-fg)]">
                …
              </span>
            </li>
          ) : (
            <li key={item}>
              <button
                ...
                className={`w-10 h-10 flex items-center justify-center rounded-[10px] text-[18px] font-['Source_Sans_Pro'] transition ${
                  item === currentPage
