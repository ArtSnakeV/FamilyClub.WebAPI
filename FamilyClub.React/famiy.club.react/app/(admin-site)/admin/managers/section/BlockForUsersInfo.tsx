...
export default function BlockForUsersInfo({
    ...
    return (
        <div
            className="w-[300px] max-w-full h-auto min-h-[170px] relative z-10 flex flex-row flex-wrap items-center px-10 gap-6"
            style={{
                backgroundImage: "url('/images/usersPageAdmin/Rectangle 686.png')",
                backgroundSize: "100% 100%",
                backgroundPosition: "center",
        ...
        >
            ...
            <div className="flex flex-col min-w-[100px] max-w-full flex-1 -mt-2">
                <span className="font-['Source_Sans_Pro'] 
                text-[var(--color-black)] font-semibold 
                text-[20px] leading-[150%] tracking-[-0.011em] truncate">
                    {title}
                </span>
                <span className="font-['Source_Sans_Pro'] 
                text-[var(--color-black)] font-semibold 
