...
export default function BlockForUsersInfo({
    ...
    return (
        <div className="w-[300px] max-w-full h-auto min-h-[170px] relative z-10 flex flex-row flex-wrap items-center px-10 gap-6 overflow-hidden">
            <div
                aria-hidden
            ...
            <div className="relative z-10 flex flex-col min-w-[100px] max-w-full flex-1 -mt-2 text-[var(--foreground-primary)]">
                <span className="font-['Source_Sans_Pro'] font-semibold text-[20px] leading-[150%] tracking-[-0.011em] truncate">
                    {title}
                </span>
