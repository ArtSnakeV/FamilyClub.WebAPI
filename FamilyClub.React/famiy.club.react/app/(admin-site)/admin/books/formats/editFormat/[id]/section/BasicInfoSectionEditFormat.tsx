        ...
        <div className="flex w-[390px] relative top-[46px] flex-col gap-4">
          ...
          <div className="p-4 top-[24px] relative w-full flex flex-col gap-5">
            ...
            <button
              ...
              className="w-full h-[40px] rounded-[55px] bg-transparent text-[#005B33] border-2 border-[#005B3380] text-[20px] font-medium transition-all duration-200 hover:opacity-90 hover:shadow-[0px_0px_20px_0px_#00000080] active:scale-[0.98] disabled:opacity-50"
            >
