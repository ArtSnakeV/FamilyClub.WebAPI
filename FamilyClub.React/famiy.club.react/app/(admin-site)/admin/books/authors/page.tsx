  ...
  const sortedAuthors = [...filteredAuthors].sort((a, b) => {
    ...
    if (sortOrder === "name-old") return (a.id ?? 0) - (b.id ?? 0);
      if (sortOrder === "name-asc") {
        return (a.authorName ?? "")
          .trim()
          .localeCompare((b.authorName ?? "").trim(), "uk");
      }
    ...
    >
      <div className="w-full min-h-screen relative">
        ...
        <div className="flex flex-col">
          ...
          >
            {/* <div className="relative self-center mt-8 ml-4"
              style={{
                backgroundImage:
                  "url('/images/authorPageAdmin/Rectangle 708.svg')",
            ...
            > */}
            <div
              className="w-full min-h-screen bg-no-repeat ml-4 flex flex-col"
              style={{
                backgroundImage:
                  "url('/images/authorPageAdmin/Rectangle 708.svg')",
            ...
            >
              ...
              <div className="relative flex flex-row items-center gap-4 top-[60px] pt-[20px] px-[32px]">
                {/* Пошук */}
              ...
              <div className="mt-4 relative top-[60px] ">
                        ...
                        >
                          ...
                          <div className="flex flex-col gap-2 flex-shrink-0">
                            <button
                              ...
                              onClick={() =>
                                router.push(`/editAuthor/${author.id}`)
                              }
                            >
                              <img
                                src="/images/authorPageAdmin/pen-to-square-solid-full 1.svg"
