      ...
      >
        <div className="flex w-[390px] relative top-[46px] flex-col gap-1">
          ...
          <input
            ...
            className="input rounded-[9px] px-3 bg-[var(--background-elevated)] text-[var(--foreground-primary)] shadow-[var(--shadow-input)] border border-[color-mix(in_srgb,var(--foreground-primary)_14%,transparent)] outline-none h-[40px]"
          />
          ...
          <div className="flex flex-col gap-1 pt-2">
            ...
            <textarea
              ...
              className="px-2 h-[80px] resize-none input rounded-[9px] bg-[var(--background-elevated)] text-[var(--foreground-primary)] shadow-[var(--shadow-input)] border border-[color-mix(in_srgb,var(--foreground-primary)_14%,transparent)] outline-none"
            />
          </div>
