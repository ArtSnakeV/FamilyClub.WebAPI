...
import useEditTranslatorForm from "./hooks/useEditTranslatorForm";
import useSubmitEditTranslator from "./hooks/useSubmitEditTranslator";
import { BasicInfoSectionEditTranslator } from "./section/BasicInfoSectionEditTranslator";
import ButtonReturn from "./ButtonReturn";

export default function EditTranslatorClient({ id }: { id: string }) {
  ...
  const {
    ...
    setField,
    loading: formLoading,
  } = useEditTranslatorForm(translatorId);

  const { handleSubmit, loading, handleDelete } = useSubmitEditTranslator({
    id: translatorId,
    form,
    router,
  });
        ...
        >
          <div className="w-full flex justify-center ml-2 items-center">
            <div className="w-[485px] relative flex flex-col">
              <BasicInfoSectionEditTranslator
                form={form}
                setField={setField}
                loading={loading}
