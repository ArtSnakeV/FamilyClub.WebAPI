...
import { useSubmitBookSize } from "./hooks/useSubmitBookSize";
import { useBookSizeForm } from "./hooks/useBookSizeForm";
import ButtonReturn from "../editBookSize/[id]/ButtonReturn";

export default function AddBookSizePage() {
  const router = useRouter();
  const { form, setField } = useBookSizeForm();
  const { handleSubmit, loading } = useSubmitBookSize({ form, router });
