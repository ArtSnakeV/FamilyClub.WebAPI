...
//                         src={icon}
//                         alt={name}
//                         className="w-[36px] h-[36px] object-contain cursor-pointer hover:opacity-80 transition-opacity duration-200"
//                     />
//                 </a>
//             ))}

//             <button
//                 className="ml-4 px-4 py-2 text-[var(--color-white)] cursor-pointer relative left-[480px] rounded-[20px] text-[16px] bg-[#005B33] font-semibold hover:bg-[#097E4B] hover:text-[var(--color-white)] transition-colors duration-200"
