...
| [**apiClubMemberIdChangePasswordPut**](ClubMemberApi.md#apiclubmemberidchangepasswordput) | **PUT** /api/ClubMember/{id}/change-password |  |
...
| [**apiClubMemberIdLockPut**](ClubMemberApi.md#apiclubmemberidlockput) | **PUT** /api/ClubMember/{id}/lock |  |
| [**apiClubMemberIdUnlockPut**](ClubMemberApi.md#apiclubmemberidunlockput) | **PUT** /api/ClubMember/{id}/unlock |  |
...
## apiClubMemberIdChangePasswordPut

> apiClubMemberIdChangePasswordPut(id, changePasswordClubMemberDto)
...
import type { ApiClubMemberIdChangePasswordPutRequest } from '';
...
async function example() {
  ...
  const body = {
    // string
    id: id_example,
    // ChangePasswordClubMemberDto (optional)
    changePasswordClubMemberDto: ...,
  } satisfies ApiClubMemberIdChangePasswordPutRequest;

  try {
    const data = await api.apiClubMemberIdChangePasswordPut(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **changePasswordClubMemberDto** | [ChangePasswordClubMemberDto](ChangePasswordClubMemberDto.md) |  | [Optional] |
...
import type { ApiClubMemberIdLockPutRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.apiClubMemberIdLockPut(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
## apiClubMemberIdUnlockPut

> apiClubMemberIdUnlockPut(id)
...
import type { ApiClubMemberIdUnlockPutRequest } from '';
...
async function example() {
  ...
  const body = {
    // string
    id: id_example,
  } satisfies ApiClubMemberIdUnlockPutRequest;

  try {
    const data = await api.apiClubMemberIdUnlockPut(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
